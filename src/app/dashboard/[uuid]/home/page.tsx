...
const PortalPage = async ({ params }: PortalPageProps) => {
	...
	return (
		<div className="w-screen min-h-screen flex flex-col">
			...
			<div className="w-full flex flex-1 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32">
				...
				<div className="w-full flex flex-col p-1">
					<div className="space-y-6 md:space-y-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[350px_1fr] xl:grid-cols-[400px_1fr] gap-4 md:gap-6 items-start">
			...
			<div
				id="all-invoices"
				className="w-full bg-orange-50 flex flex-1 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 mt-6"
			>
